...
atimis_data_root='
cyl_data_root='/lustre/scratch5/exempt/artimis/data/cx241203_fp16_full'
pli_data_root='/lustre/scratch5/exempt/artimis/data/lsc240420_fp16_full'

DATA_ROOT="/lustre/scratch5/exempt/artimis/spandit/datasets"
...
echo $DATA_PLI
echo $DATA_CYL
tgt_data=${DATA_ROOT}/$DATASET/${PRECISION}/${IMG_SIZE}
